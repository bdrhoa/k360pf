...
async def make_kount_api_request(
    ...
    """Post an NAO V2 inquiry, retrying transient failures up to three times."""
    ...
    async with session.post(KOUNT_NAO_API_ENDPOINT, json=payload, headers=headers) as response:
